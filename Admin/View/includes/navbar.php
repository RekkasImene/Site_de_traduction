                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="../View/ChartsTraduction1.php" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts"
                                ><div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                Nombre de traduction
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div
                            ></a>
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="../View/ChartsTraduction1.php">Faite entre 2 dates</a><a class="nav-link" href="../View/ChartsTraduction1.php">Faite par un traducteur entre 2 dates</a>
                             <a class="nav-link" href="../View/ChartsTraduction1.php">Faite par un client entre 2 dates</a>
                                </nav>
                            </div>
                            
                            <a class="nav-link collapsed" href="../View/ChartsTraduction1.php" data-toggle="collapse" data-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages"
                                ><div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                Nombre de devis
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div
                            ></a>
                            ...
                            <a class="nav-link" href="../View/ChartsTraduction1.php">Faite entre 2 dates</a><a class="nav-link" href="../View/ChartsTraduction1.php">Faite par un traducteur entre 2 dates</a>
                             <a class="nav-link" href="../View/ChartsTraduction1.php">Faite par un client entre 2 dates</a>
                                </nav>
                            </div>
